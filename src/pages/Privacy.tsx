            ...
            <div className="space-y-8">
              <section className="space-y-4">
                ...
                <p className="text-muted-foreground">
                  GetRoastedOnline ("we," "us," or "our") is committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our website, mobile application, and related services (collectively, the "Services").
                </p>
                <p className="text-muted-foreground">
