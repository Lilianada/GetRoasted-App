    ...
    <div className="space-y-2">
      ...
      >
        <div className="flex items-center space-x-2">
          <RadioGroupItem value="180" id="t1" className="text-flame-500" />
          <Label htmlFor="t1" className="flex items-center gap-2 cursor-pointer">
            3 Minutes
          </Label>
        </div>
        <div className="flex items-center space-x-2">
          <RadioGroupItem value="360" id="t2" className="text-flame-500" />
          <Label htmlFor="t2" className="flex items-center gap-2 cursor-pointer">
            6 Minutes
          </Label>
        </div>
        <div className="flex items-center space-x-2">
          <RadioGroupItem value="600" id="t3" className="text-flame-500" />
